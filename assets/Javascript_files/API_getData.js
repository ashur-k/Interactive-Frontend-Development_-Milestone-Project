...
//http method to retreive API Data
...
//function for updating Flage image
function printflag(flagName) {
    document.getElementById("img").src = `assets/Images/flag-svg/${flagName}.svg`;
}
// Main Function To print values on HTML PAGE
function printToDocument(countryName) {

    //taking country name (value) in printflag function to print correct country flag
    printflag(countryName);

    //Gettin data from API callback function
    getCoronoData(countryName, function (data) {
        ...
        //Getting Deaths data keys and values to print on HTML5 page, these values are going to span ids on html5 page
